...
const content = {
  id: {
    ...
    projects: {
      ...
      items: [
        { title: "Pantau Cuaca/Weather Monicon (ID/EN)", type: "Data Science", icon: <Leaf />, color: "#009736", url: "https://weathermonicon.streamlit.app/", image: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=800&q=80", story: "Aplikasi web interaktif yang menyediakan pemantauan cuaca secara real-time." },
  ...
  en: {
    ...
    projects: {
      ...
      items: [
        { title: "Pantau Cuaca/Weather Monicon (ID/EN)", type: "Data Science", icon: <Leaf />, color: "#009736", url: "https://weathermonicon.streamlit.app/", image: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=800&q=80", story: "Real-time Interactive web application providing weather monitoring." },
